# CO₂ Spar Rechner
This is the backend for the **YoungCaritas Kleidertausch CO₂ Savings Calculator**, developed as an end of semester final project to improve the original system with:
